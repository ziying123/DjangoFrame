...
from DjangoFrame.apps.user.models import User, Address
...
class LoginView(View):
    ...
    def post(self, request):
        ...
        if user is not None:
            ...
            # 用户名或密码错误
            logger.warning("用户：{} 登录失败.".format(username))
...
class UserInfoView(View):
    ...
    def get(self, request):
        ...
        logger.info("用户 {} 浏览商品信息： {} ".format(user.id, context))
